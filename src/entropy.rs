...
/// Lowered from 5000 to 800 — break-even analysis shows table overhead
/// (~272 bytes worst case) is covered at ~800 bytes stream size.
/// Repetitive (158B fold1) and random (fold0 passthrough) are both
/// still safely below this threshold.
