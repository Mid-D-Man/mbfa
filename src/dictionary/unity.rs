...
// live in docs/mbfa/dictionary.md, section "unity.rs"
// ============================================================================
...
//! blocks), verified via held-out same-format testing against
//! independently-varied samples. See dictionary/mod.rs for the per-format
//! selection this enables.
